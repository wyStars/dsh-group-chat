...
`;
		...
		function Panel() {
			...
			return (0, react.createElement)("div", { className: "dshgc-overlay" }, (0, react.createElement)("div", { className: "dshgc-panel" }, (0, react.createElement)("div", { className: "dshgc-head" }, (0, react.createElement)("span", {
			...
			}), (0, react.createElement)("div", { className: "dshgc-row" }, (0, react.createElement)("label", null, "轮数"), (0, react.createElement)("input", {
				className: "dshgc-num",
				type: "number",
				min: 1,
				max: 10,
			...
			}, generating ? "⏳ 生成中…" : "✨ 生成角色团队")), roles.length > 0 ? (0, react.createElement)("div", {}, (0, react.createElement)("div", { className: "dshgc-label" }, `角色团队（${roles.length}）`), (0, react.createElement)("div", { className: "dshgc-roles" }, roles.map((r) => (0, react.createElement)("span", {
				...
				onClick: send
			}, "发送"))), snap && snap.summary ? (0, react.createElement)("div", { className: "dshgc-section" }, (0, react.createElement)("div", { className: "dshgc-label" }, "结论"), (0, react.createElement)("div", { className: "dshgc-summary" }, snap.summary), snap.mdPath ? (0, react.createElement)("div", { className: "dshgc-path" }, "已保存：" + snap.mdPath) : null) : null));
		}
			...
			(0, react.useEffect)(() => {
				...
				const tick = async () => {
					...
					try {
						...
						if (s.phase === "discussing" || s.phase === "generating-roles" || s.phase === "summarizing") openPanel(bus.sessionId);
					} catch {}
				};
				tick();
