...
`;
		...
		function Panel() {
				...
				const tick = async () => {
					try {
						...
						if (snapNow.version !== last) {
							...
							setSnap(snapNow);
							if (snapNow.phase === "idle" && snapNow.roles.length > 0 && !snapNow.error) setGenerating(false);
						}
					} catch {
			...
			const refreshDraft = (0, react.useCallback)(() => {
			...
			const controls = (0, react.createElement)("div", { className: "dshgc-row" }, canStart && roles.length > 0 ? (0, react.createElement)("button", {
			...
			return (0, react.createElement)("div", {
			...
			}, (0, react.createElement)("div", { className: "dshgc-panel" }, (0, react.createElement)("div", { className: "dshgc-head" }, (0, react.createElement)("div", { className: "dshgc-title" }, "💬 群聊讨论", (0, react.createElement)("span", { className: "dshgc-badge" }, PHASE_LABEL[phase] || phase)), (0, react.createElement)("button", {
				className: "dshgc-close",
				onClick: closePanel,
				title: "关闭"
			}, "×")), (0, react.createElement)("div", { className: "dshgc-body" }, offline ? (0, react.createElement)("div", { className: "dshgc-offline" }, "⚠ 已与群聊服务断开（插件可能已卸载/重载）") : null, notice ? (0, react.createElement)("div", {}, notice) : null, (0, react.createElement)("div", { className: "dshgc-section" }, (0, react.createElement)("div", { className: "dshgc-label" }, "任务 / 设计需求"), (0, react.createElement)("textarea", {
			...
			}), (0, react.createElement)("div", { className: "dshgc-row" }, (0, react.createElement)("label", null, "讨论轮数"), (0, react.createElement)("input", {
				className: "dshgc-num",
				type: "number",
				min: 1,
				max: 10,
				...
				onClick: () => run(async () => {
					setNotice("正在生成角色团队…");
					await postAction("generate-roles", {
						task: draft,
						rounds
					});
					setNotice("");
				})
			}, generating ? "⏳ 生成中…" : "✨ 生成角色团队"))), roles.length > 0 ? (0, react.createElement)("div", { className: "dshgc-section" }, (0, react.createElement)("div", { className: "dshgc-label" }, `角色团队（${roles.length} 人）`), (0, react.createElement)("div", { className: "dshgc-roles" }, roles.map((r, i) => (0, react.createElement)("div", {
				className: "dshgc-role",
				key: r.id
			}, (0, react.createElement)("span", {
				className: "dshgc-avatar",
				style: { background: avatarColor(r.id) }
			}, roleInitial(r.name)), (0, react.createElement)("div", { className: "dshgc-roleInfo" }, (0, react.createElement)("div", { className: "dshgc-roleName" }, r.name), (0, react.createElement)("div", { className: "dshgc-roleMeta" }, (r.duty ? "【" + r.duty + "】" : "") + r.persona)), (0, react.createElement)("button", {
			...
			}, "🗑"))), showRoleForm ? (0, react.createElement)("div", {
				className: "dshgc-roleForm",
				key: "role-form"
			}, (0, react.createElement)("input", {
				className: "dshgc-input",
				placeholder: "角色名（如：UX 设计师）",
			...
			}, "+ 添加角色"), (0, react.createElement)("div", null, (0, react.createElement)("button", {
				className: "dshgc-btn",
				disabled: !canGenerate || offline,
				onClick: () => run(() => postAction("generate-roles", {
					task: snap ? snap.task : draft,
					rounds
				}))
			}, "🔄 重新生成角色团队")))) : null, (0, react.createElement)("div", {
				className: "dshgc-msgs",
				ref: msgsRef
			}, messages.length === 0 ? (0, react.createElement)("div", { className: "dshgc-empty" }, inDiscuss ? "讨论准备中…" : "暂无发言：先输入任务并生成角色团队，再开始讨论") : null, messages.map((m) => (0, react.createElement)("div", {
				className: "dshgc-msg",
				key: m.id
			}, (0, react.createElement)("span", {
				className: "dshgc-avatar",
				style: { background: avatarColor(m.roleId) }
			}, roleInitial(m.name)), (0, react.createElement)("div", { className: "dshgc-msgBody" }, (0, react.createElement)("div", { className: "dshgc-msgName" }, m.name), (0, react.createElement)("div", {
				className: "dshgc-msgText",
				"data-failed": String(m.failed === true)
			}, m.text)))), inDiscuss && snap && snap.streamingRoleId ? (0, react.createElement)("div", { className: "dshgc-typing" }, "● " + roleName(snap, snap.streamingRoleId) + " 正在输入…") : null), inDiscuss ? (0, react.createElement)("div", { className: "dshgc-section" }, controls) : null, snap && snap.error ? (0, react.createElement)("div", { className: "dshgc-error" }, "⚠ " + snap.error) : null, snap && snap.summary ? (0, react.createElement)("div", { className: "dshgc-section" }, (0, react.createElement)("div", { className: "dshgc-label" }, "结论"), (0, react.createElement)("div", { className: "dshgc-summary" }, snap.summary), (0, react.createElement)("div", { className: "dshgc-row" }, (0, react.createElement)("button", {
				className: "dshgc-btn",
				disabled: offline,
				onClick: () => run(async () => {
					await postAction("export-md");
				})
			}, "📄 导出 MD"), (0, react.createElement)("button", {
				className: "dshgc-btn",
				onClick: () => run(async () => {
					if (navigator.clipboard && navigator.clipboard.writeText) {
						await navigator.clipboard.writeText(snap.mdContent || snap.summary);
						setNotice("已复制到剪贴板");
					} else setNotice("当前环境不支持剪贴板");
				})
			}, "📋 复制内容"), (0, react.createElement)("button", {
				className: "dshgc-btn",
				disabled: offline,
				onClick: () => run(async () => {
					await postAction("sync-rounds", { rounds });
			...
			}, "🔄 再来一轮")), snap.mdPath ? (0, react.createElement)("div", { className: "dshgc-path" }, "已保存：" + snap.mdPath) : null) : null, (phase === "idle" || phase === "done" || phase === "error") && messages.length > 0 && !snap.summary ? (0, react.createElement)("div", { className: "dshgc-section" }, controls) : null)));
		}
