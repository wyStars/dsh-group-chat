...
`;
		...
		function Panel() {
			...
			}, m.text)))), inDiscuss && snap && snap.streamingRoleId ? (0, react.createElement)("div", { className: "dshgc-typing" }, "● " + roleName(snap, snap.streamingRoleId) + " 正在输入…") : null), inDiscuss ? (0, react.createElement)("div", { className: "dshgc-section" }, controls) : (phase === "idle" || phase === "done" || phase === "error") && (roles.length > 0 || messages.length > 0) ? (0, react.createElement)("div", { className: "dshgc-section" }, controls) : null, snap && snap.error ? (0, react.createElement)("div", { className: "dshgc-error" }, "⚠ " + snap.error) : null, snap && snap.summary ? (0, react.createElement)("div", { className: "dshgc-section" }, (0, react.createElement)("div", { className: "dshgc-label" }, "结论"), (0, react.createElement)("div", { className: "dshgc-summary" }, snap.summary), (0, react.createElement)("div", { className: "dshgc-row" }, (0, react.createElement)("button", {
				className: "dshgc-btn",
				disabled: offline,
				onClick: () => run(async () => {
					await postAction("export-md");
			...
			}, "🔄 再来一轮")), snap.mdPath ? (0, react.createElement)("div", { className: "dshgc-path" }, "已保存：" + snap.mdPath) : null) : null)));
		}
